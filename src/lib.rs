...
#[derive(Debug)]
pub struct SessionStoreProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SessionStoreProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SessionStore processing");
    
    let mut processor = SessionStoreProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SessionStoreProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SessionStoreProcessor::new(false);
